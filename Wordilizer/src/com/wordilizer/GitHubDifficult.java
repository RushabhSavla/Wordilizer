...
public class GitHubDifficult extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		employees = db.getEmployeesDifficult(); // you would not typically call this on the main thread
		...
		ListAdapter adapter = new SimpleCursorAdapter(this, 
				...
				protected void onListItemClick(ListView l, View v, int position, long id) {
					...
					try {
						...
						hon.open();
						String returnedWord=hon.getWordDifficult(id);
						String returnedMeaning=hon.getMeaningDifficult(id);
						String returnedOwn=hon.getOwnDifficult(id);
						hon.close();
