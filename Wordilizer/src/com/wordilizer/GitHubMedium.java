...
public class GitHubMedium extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		employees = db.getEmployeesMedium(); // you would not typically call this on the main thread
		...
		ListAdapter adapter = new SimpleCursorAdapter(this, 
				...
				protected void onListItemClick(ListView l, View v, int position, long id) {
					...
					try {
						...
						hon.open();
						String returnedWord=hon.getWordMedium(id);
						String returnedMeaning=hon.getMeaningMedium(id);
						String returnedOwn=hon.getOwnMedium(id);
						hon.close();
