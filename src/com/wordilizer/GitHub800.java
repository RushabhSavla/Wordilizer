...
public class GitHub800 extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		employees = db.getEmployees800(); // you would not typically call this on the main thread
		...
		ListAdapter adapter = new SimpleCursorAdapter(this, 
				...
				protected void onListItemClick(ListView l, View v, int position, long id) {
					...
					try {
						...
						hon.open();
						String returnedWord=hon.getWord800(id);
						String returnedMeaning=hon.getMeaning800(id);
						String returnedOwn=hon.getOwn800(id);
						hon.close();
